                    ...
                    <Row className="align-items-center">
                        <Col md={12} sm={12} lg={6}>
                            <div className="hero-slide-left justify-content-end align-items-center text-center text-lg-start">
                                ...
                                <p className="mb-xs-5">Join us to a fun and friendly Health Care environment. Our professionals are working so hard to see smile on your face that you deserve! We are dedicated about our duties.</p>
                        ...
                        <Col md={12} sm={12} lg={6} className="mt-sm-5">
                            <div className="hero-slide-right text-top text-lg-start mt-sm-5" >
                                    <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSzSURJudwIGdLywRpV8cohsYl94LvTYt2lag&usqp=CAU" alt="not found" width="100%"/>
                            </div>
                        </Col>
                    </Row>
                </Container>
